namespace threadRace
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Thread.CurrentThread.Name = "Princess Peach";
                for (int i = 0; i < 100; i++)
                {
            ...
            {
                Thread.CurrentThread.Name = "Super Mario";
                for (int i = 0; i < 100; i++)
                {
                    if (t1Location < 100 && t2Location < 100 && t3Location < 100 && t4Location < 100 && t5Location < 100)
            ...
            {
                Thread.CurrentThread.Name = "Donkey Kong";
                for (int i = 0; i < 100; i++)
                {
                    if (t1Location < 100 && t2Location < 100 && t3Location < 100 && t4Location < 100 && t5Location < 100)
            ...
            {
                Thread.CurrentThread.Name = "Bowser";
                for (int i = 0; i < 100; i++)
                {
                    if (t1Location < 100 && t2Location < 100 && t3Location < 100 && t4Location < 100 && t5Location < 100)
            ...
            {
                Thread.CurrentThread.Name = "Goomba";
                for (int i = 0; i < 100; i++)
                {
                    if (t1Location < 100 && t2Location < 100 && t3Location < 100 && t4Location < 100 && t5Location < 100)
